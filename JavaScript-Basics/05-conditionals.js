...
var episode = 10
if(episode =10){
    console.log("I need season two NOW.")
}
...
var isInRetrograde = false;
if(isInRetrograde == false) {
    console.log("You're safe. Be about your business.")
}
if(isInRetrograde == true) {
    console.log("Mercury is in retrograde. Hide.")
}